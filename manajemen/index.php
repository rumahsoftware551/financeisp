  ...
  <section class="content">
    <div class="finance-welcome">
      <div class="finance-welcome-content">
        <span class="finance-welcome-eyebrow"><i class="fa fa-shield"></i>&nbsp; Dashboard Manajemen</span>
    ...
    <div class="row">
      ...
      <div class="col-lg-4">
        <div class="finance-panel">
          <div class="finance-panel-header"><div><div class="finance-panel-title">Aksi Cepat</div><div class="finance-panel-subtitle">Akses fitur utama</div></div></div>
          <div class="finance-panel-body">
            <div class="finance-quick-grid">
              ...
              <a class="finance-quick-action" href="bank.php"><i class="fa fa-university"></i><span>Lihat Rekening</span></a>
              <a class="finance-quick-action" href="laporan.php"><i class="fa fa-file-text-o"></i><span>Buka Laporan</span></a>
              <a class="finance-quick-action" href="hutang.php"><i class="fa fa-handshake-o"></i><span>Hutang Piutang</span></a>
            </div>
          </div>
        </div>
      </div>
